...
class TestRoutingInfoUpdateForwarding:
    ...
    async def _setup_bridge_and_sender(self, dbus, mctpd):
        ...
        # Discover endpoints[0] as a downstream bridge -- it reports the bridge
        # endpoint type because it has a bridged endpoint behind it. This is
        # the peer updates are forwarded to.
